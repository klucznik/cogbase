...
abstract class FileSystem {
	 ...
	 */
	public static function copy($originFile, $targetFile, $overwriteNewerFiles = false) : void {
		self::initialize();
	 ...
	 * @throws IOException When the change fail
	 */
	public static function chgrp($files, $group, $recursive = false) : void {
		self::initialize();
	 ...
	 */
	public static function dumpFile($filename, $content) : void {
		self::initialize();
